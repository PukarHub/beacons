    ...
    <div>
      <form onSubmit={handleSignUp} className="signupform">
       <h1 id="signin">Sign in</h1>
        <p> <strong>Not sure how to sign in?</strong> </p>
        <p><strong>Click <Link id="link" to="/"> here</Link></strong></p> <br/>
       ...
       <button id="facebookbtn" onClick={SignInWithFacebook} >
        ...
        <button id="submitbtn" type="submit">Sign in with Email</button> <br/> <br/> <br/>
        <Link id="link" to="/forgotpassword">Forgot password?</Link> <br/> <br/>
